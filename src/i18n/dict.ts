...
export const DICT: Record<string, DictEntry> = {
  ...
  'title.modeStandard': { zh: '关卡1', en: 'Stage 1' },
  'title.modeStandardDesc': { zh: '标准流程：击败终焉逃出幽墟', en: 'Standard run: defeat the Endless and escape the Hollow.' },
  'title.modeStage2': { zh: '关卡2', en: 'Stage 2' },
  'title.modeStage2Desc': { zh: '怪物血量 ×2 · 机制不变', en: 'Enemy HP ×2 · same mechanics.' },
  'title.modeStage3': { zh: '关卡3', en: 'Stage 3' },
  'title.modeStage3Desc': {
    zh: '小怪 HP ×3 · 伤害 ×2 · 泣灵→渊喉→巢母',
    en: 'Minion HP ×3 · dmg ×2 · Lament → Maw → Hive Matriarch',
  },
  ...
  'title.modeSpecial': { zh: '特殊关卡', en: 'Special Stage' },
  'title.modeSpecialDesc': { zh: '怪物血量 ×3 · 每 3 分钟同种 Boss×3', en: 'Enemy HP ×3 · 3 same bosses every 3 minutes' },
